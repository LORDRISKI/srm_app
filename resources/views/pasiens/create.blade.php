        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-100">
                <div class="p-6 sm:p-8 bg-white">
                    ...
                    <form method="POST" action="{{ route('pasiens.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input id="no_rm" type="text" name="no_rm" value="{{ old('no_rm') }}" placeholder="Contoh: RM-0001" required
                            ...
                            <div>
                                ...
                                <input id="nik" type="text" name="nik" value="{{ old('nik') }}" placeholder="Masukkan 16 digit NIK" maxlength="16"
                        ...
                        <div>
                            ...
                            <input id="nama_pasien" type="text" name="nama_pasien" value="{{ old('nama_pasien') }}" placeholder="Nama lengkap sesuai KTP" required
                                class="w-full mt-1.5 px-4 py-2.5 border border-gray-300 rounded-lg text-gray-900 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition outline-none">
                        ...
                        <div>
                            ...
                            <input id="no_hp" type="text" name="no_hp" value="{{ old('no_hp') }}" placeholder="Contoh: 0812xxxxxxxx"
                                class="w-full mt-1.5 px-4 py-2.5 border border-gray-300 rounded-lg text-gray-900 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition outline-none">
                        ...
                        <div>
                            ...
                            <textarea id="alamat" name="alamat" rows="3" placeholder="Alamat lengkap pasien..."
                                class="w-full mt-1.5 px-4 py-2.5 border border-gray-300 rounded-lg text-gray-900 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition outline-none resize-none">{{ old('alamat') }}</textarea>
